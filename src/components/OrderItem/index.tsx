...
export const OrderItem: React.FC<Props> = ({ order }) => {
  ...
  return (
    <div className="bg-card rounded-lg px-4 py-2 md:px-6 md:py-4 flex flex-col sm:flex-row gap-12 sm:items-center sm:justify-between shadow-sm shadow-black/10 dark:shadow-black/40">
